...
{
	public class BinarySerializationBoxedPrimitiveSegmentTests
	{
		[TestFixture]
		public class When_asked_if_IsMatch
		{
			...
			[Test]
			public void Given_a_MemoryStream_having_byte_at_Position_equal_to_0x08()
			{
				Test.Verify(
					with_type_id_at_position_equal_to_0x08,
					when_asked_if_IsMatch,
					should_return_true,
					should_not_change_Position
					);
			...
			private void with_type_id_at_position_equal_to_0x08()
			{
